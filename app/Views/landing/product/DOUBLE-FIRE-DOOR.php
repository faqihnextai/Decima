<div id="prod-double-fire-door" class="product-item reveal-on-scroll">
    <div class="product-media">
        <div class="door-frame-box">
            <img src="<?= base_url('assets/img/product/double-fire-door.jpg') ?>" alt="<?= t('Product.dfd_title') ?>" loading="lazy">
            <span class="product-badge"><?= t('Product.dfd_badge') ?></span>
        </div>
    </div>
